<?php $__env->startSection('title', 'Despre noi | ReclamDesign Modern'); ?>
    ...
    <div class="about-location-card">
        <div class="about-location-content">
            ...
            <div class="route-actions" aria-label="Optiuni traseu">
                ...
                >
                    <img src="<?php echo e(asset('assets/MAP_MAN/omul.png')); ?>" alt="" aria-hidden="true" class="route-person-img">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\routu\OneDrive\Рабочий стол\Stable_Optimizate\resources\views/despre-noi.blade.php ENDPATH**/ ?>