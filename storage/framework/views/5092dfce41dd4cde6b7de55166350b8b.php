...
<body>
    <div class="card">
        ...
        <div class="content">
            <p>Bună, <?php echo e($thread->fullName()); ?>!</p>
            <p>Am revenit cu un răspuns la solicitarea ta:</p>

            <div class="message"><?php echo e($contactMessage->body); ?></div>

            <a class="button" href="<?php echo e($customerUrl); ?>">Continuă conversația</a>
            <p class="muted">Mesajele trimise prin butonul de mai sus rămân salvate în același fir de conversație.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\routu\OneDrive\Рабочий стол\Stable_Optimizate\resources\views/emails/contact_customer_reply.blade.php ENDPATH**/ ?>