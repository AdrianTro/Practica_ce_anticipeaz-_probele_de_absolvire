        ...
        <div class="admin-block admin-products-block" id="admin-products">
            ...
            <div class="admin-product-grid">
                ...
                <?php if ($adminProducts->count() === 0) { ?>
                    <div class="empty-state">Nu exista produse.</div>
                <?php } else { ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\routu\OneDrive\Рабочий стол\Stable_Optimizate\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>