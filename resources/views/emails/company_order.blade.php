...
<head>
    <meta charset="utf-8">
    <style>
        body { font-family: Arial, sans-serif; background: #111827; color: #172033; margin: 0; padding: 24px; }
        .card { max-width: 980px; margin: auto; background: #ffffff; border-radius: 18px; overflow: hidden; }
        .header { background: #ff8a00; color: #ffffff; padding: 28px; }
